package com.order.entityUpdateOrder.json;
...
@Entity(name = "UpdateOrderStatusJson")
public class UpdateOrderMsgJsonEntity implements Serializable {
    ...
    public UpdateOrderMsgJsonEntity() {
